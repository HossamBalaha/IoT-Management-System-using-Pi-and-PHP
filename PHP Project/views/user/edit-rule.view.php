              ...
              <div class="col-12 col-md-9">
                <select name="sensor" id="sensor" class="form-control" required>
                  <?php foreach ($sensors as $sensor) { ?>
                    <option <?php echo ($sensor['id'] == $selectedRule['sensor_id']) ? "selected" : "" ?>
              ...
              <div class="col-12 col-md-9">
                <select name="actuator" id="actuator" class="form-control" required>
                  <?php foreach ($actuators as $actuator) { ?>
                    <option <?php echo ($actuator['id'] == $selectedRule['actuator_id']) ? "selected" : "" ?>
            ...
            <div class="form-group row text-center">
              ...
              <div class="col-12 col-md-9">
                <input type="text" name="reading"
                       maxlength="5"
                       value="<?php echo isset($selectedRule['value']) ? $selectedRule['value'] : '' ?>"
              ...
              <div class="col-12 col-md-9">
                <select name="operator" id="operator" class="form-control" required>
                  <?php foreach ($operators as $operator) { ?>
                    <option <?php echo ($operator['id'] == $selectedRule['operator_id']) ? "selected" : "" ?>
            ...
            <div class="form-group row text-center">
              ...
              <div class="col-12 col-md-9">
                <select name="state" id="state" class="form-control" required>
                  <option <?php echo ($selectedRule['state'] == 1) ? "selected" : "" ?>
                      value="1">ON
                  </option>
                  <option <?php echo ($selectedRule['state'] == 0) ? "selected" : "" ?>
                      value="0">OFF
                  </option>
                </select>
              </div>
